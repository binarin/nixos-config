      ...
      settings = {
        ...
        "browser.uiCustomization.state" = builtins.toJSON {
          ...
          placements = {
            ...
            TabsToolbar = [ ];
            nav-bar = [ "back-button" "forward-button" "stop-reload-button" "customizableui-special-spring1" "urlbar-container" "alltabs-button" "new-tab-button" "customizableui-special-spring2" "_ddefd400-12ea-4264-8166-481f23abaa87_-browser-action" "savepage-we_dw-dev-browser-action" "_08f0f80f-2b26-4809-9267-287a5bdda2da_-browser-action" "_8f8c4c52-216c-4c6f-aae0-c214a870d9d9_-browser-action" "_446900e4-71c2-419f-a6a7-df9c091e268b_-browser-action" "_testpilot-containers-browser-action" "ublock0_raymondhill_net-browser-action" "downloads-button" "sidebar-button" "unified-extensions-button" ];
            toolbar-menubar = [ "menubar-items" ];
            unified-extensions-area = [ "sponsorblocker_ajay_app-browser-action" "myallychou_gmail_com-browser-action" "_contain-facebook-browser-action" "addon_darkreader_org-browser-action" "enhancerforyoutube_maximerf_addons_mozilla_org-browser-action" "_12cf650b-1822-40aa-bff0-996df6948878_-browser-action" "_c49b13b1-5dee-4345-925e-0c793377e3fa_-browser-action" ];
