   ...
   #+begin_src emacs-lisp :tangle yes
     (eval-and-compile
       ...
       (defun cache-file-name (&rest components)
         (apply #'file-name-concat (if (eql system-type 'windows-nt) (expand-file-name "~/.emacs.d/") xdg-cache-home) "emacs" components))
       ...
       ;; (setf package-user-dir (cache-file-name "elpa/"))
       )
   #+end_src
** MELPA on windows
