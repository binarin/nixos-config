...
** Outline
   #+BEGIN_SRC emacs-lisp :tangle yes
     ...
     ;; org-fold-show-context-detail XXX
...
** Agenda
   #+begin_src emacs-lisp :tangle yes
     ...
     (setq org-agenda-hide-tags-regexp (rx "PROJ"))
     ...
     (setq org-agenda-custom-commands '(("a" "Agenda and NEXTs" ((agenda "")
                                        ...
                                        ("w" "WAIT" todo "WAIT" ((binarin/agenda-prepend-parent t)))
...
** Capture
   #+BEGIN_SRC emacs-lisp :tangle yes
     (defun binarin/clipboard-first-line ()
       (s-trim (or (car (s-lines (or (gui-get-selection nil 'UTF8_STRING) ""))) "")))
     ...
     (setq org-capture-templates
           '(("t" "todo" entry
             ...
             ("n" "comment on clocked" plain
              (clock)
              "%?")
             ("c" "Clipboard contents" entry
              (file "~/org/refile.org")
              "* %(binarin/clipboard-first-line)\n :PROPERTIES:\n  :ID: %(org-id-new)\n  :END:\n  %U\n\n  %(gui-get-selection nil 'UTF8_STRING)" :immediate-finish t)
             ("l" "Link" entry
              (file "~/org/refile.org")
...
** Clocking
   #+BEGIN_SRC emacs-lisp :tangle yes
     ...
     (autoload 'org-clock-auto-clockout-insinuate)
...
** Org global dispatcher
   #+begin_src emacs-lisp :tangle yes
     ...
     (defun binarin/org-current-clock-headline ()
       (binarin/org-get-heading-at-marker (and (org-clocking-p) org-clock-marker)))
     ...
     (transient-define-prefix binarin/org-dispatch ()
       ...
       [:description "Go to"
                     ...
                     ("c" org-clock-goto
                      :description (lambda ()
                                     (format "Clocked: %s" (binarin/org-current-clock-headline))))]
       [:description "Actions"
