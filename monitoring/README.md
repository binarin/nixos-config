...
This directory contains Python code for generating Grafana dashboards using the
Grafana Foundation SDK. The generated JSON files are stored in version control
and deployed using grafanactl.
...
This generates dashboard manifests in `monitoring/generated/resources/`.
...
```bash
grafanactl resources push -p monitoring/generated/resources/
```
