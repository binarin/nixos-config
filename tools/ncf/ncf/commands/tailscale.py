...
def run_auth_key(
    ...
    """
    # Validate credential file args
    if (client_id_file is None) != (client_secret_file is None):
        console.print(
            "[red]Error: --client-id-file and --client-secret-file must both be provided[/red]"
        )
        raise SystemExit(1)
